    ...
    if (indexPath) {
        if ([segue.identifier isEqualToString:@"Display Photo"]) {
            if ([segue.destinationViewController isKindOfClass:[ImageViewController class]]) {
                ...
                imageViewController.imageURL = [FlickrFetcher urlForPhoto:self.photos[indexPath.row] format:FlickrPhotoFormatLarge];
                imageViewController.title = [self.photos[indexPath.row] valueForKeyPath:FLICKR_PHOTO_TITLE];
            }
        }
    }
}
